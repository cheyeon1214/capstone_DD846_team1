        ...
        <h2 class="add-review-title">
            ...
            <form class="add-review-form" @submit.prevent="submitReview">
                ...
                <div class="add-review-input-container">
                    ...
                    <textarea class="add-review-input add-review-textarea" id="content" v-model="review.content" required></textarea>
                </div>
                <div class="add-review-input-container">
...
export default {
    ...
    methods: {
        submitReview() {
            ...
            axios.post('http://localhost:3002/reviews', newReview)
                .then(() => {
                    // 리뷰 작성 후 폼 초기화
                    this.review.title = '';
                    this.review.content = '';
