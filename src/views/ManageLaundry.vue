...
export default {
    ...
    methods: {
        async addManageLaundrys() {
            ...
            )
            {
                ...
                try {
                    ...
                    const response = await axios.post('http://localhost:3005/managelaundrys', newLaundry);
        ...
        async clickEditTab() {
            try {
                const response = await axios.get(`http://localhost:3005/managelaundrys/1`);
        ...
        async editManageLaundrys() {
            ...
            )
            {
                ...
                try {
                    await axios.put('http://localhost:3005/managelaundrys/1', newLaundry);
                    console.log('데이터가 성공적으로 추가되었습니다.');
